...
# endif
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        D3DCOLOR clear_col_dx = D3DCOLOR_RGBA((int)(backgroundColor.x*255.0f), (int)(backgroundColor.y*255.0f), (int)(backgroundColor.z*255.0f), (int)(backgroundColor.w*255.0f));
