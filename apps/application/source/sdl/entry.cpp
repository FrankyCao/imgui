...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow(Application_GetName(user_handle), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, window_width, window_height, window_flags);
