...
public:
    ...
    virtual void RGBA2YUV(const ImMat& im_RGB, ImMat & im_YUV, ImColorFormat color_format, ImColorSpace color_space, ImColorRange color_range) const;
    // input RGBA planer from CPU buffer and output to YUV GPU buffer
    virtual void RGBA2YUV(const ImMat& im_RGB, VkMat & im_YUV, ImColorFormat color_format, ImColorSpace color_space, ImColorRange color_range) const;
    // input RGBA planer from GPU buffer and output to YUV CPU buffer
    virtual void RGBA2YUV(const VkMat& im_RGB, ImMat & im_YUV, ImColorFormat color_format, ImColorSpace color_space, ImColorRange color_range) const;
    // input RGBA planer from GPU buffer and output to YUV GPU buffer
    virtual void RGBA2YUV(const VkMat& im_RGB, VkMat & im_YUV, ImColorFormat color_format, ImColorSpace color_space, ImColorRange color_range) const;
...
private:
    ...
    void upload_param(const VkMat& Im_RGB, VkMat& dst, ImColorFormat color_format, ImColorSpace color_space, ImColorRange color_range) const;
