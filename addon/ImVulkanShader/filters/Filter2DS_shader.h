...
{ \n\
    ...
    { \n\
        ...
        { \n\
            sfpvec4 rgba = load_float_rgba(x, yStart - (HALO_SIZE - j) * wsy, p.w, p.cstep, p.format); \n\
    ...
    { \n\
        ...
        { \n\
            ...
            sfpvec4 rgba = load_float_rgba(x, maxIdy, p.w, p.cstep, p.format); \n\
            column_shared[ly + j * wsy][lx] = rgba; \n\
        } \n\
    } \n\
    ...
    { \n\
        ...
        { \n\
            sfpvec4 rgba = load_float_rgba(x, yStart + j * wsy, p.w, p.cstep, p.format); \n\
        ...
        for (int j = 0; j < HALO_SIZE; ++j) \n\
        { \n\
            sfpvec4 rgba = load_float_rgba(x, yStart + (PATCH_PER_BLOCK + j) * wsy, p.w, p.cstep, p.format); \n\
    ...
    { \n\
        ...
        { \n\
            ...
            int y = ly + (HALO_SIZE + j) * wsy; \n\
            sfpvec4 rgba = load_float_rgba(x, minIdy, p.w, p.cstep, p.format); \n\
            column_shared[y][lx] = rgba; \n\
        } \n\
        for (int j = 0; j < HALO_SIZE; ++j) \n\
        { \n\
    ...
    { \n\
        ...
        { \n\
            ...
            store_float_rgba(sum, x, y, p.w, p.cstep, p.format); \n\
        } \n\
    } \n\
} \
"
...
{ \n\
    ...
    { \n\
        ...
        for (int j = 0; j < HALO_SIZE; ++j) \n\
        { \n\
            sfpvec4 rgba = load_float_rgba(xStart - (HALO_SIZE - j) * wsx, y, p.w, p.cstep, p.format); \n\
    ...
    { \n\
        ...
        { \n\
            ...
            sfpvec4 rgba = load_float_rgba(maxIdx, y, p.w, p.cstep, p.format); \n\
            row_shared[ly][lx + j * wsx] = rgba; \n\
        } \n\
    } \n\
    ...
    { \n\
        ...
        for (int j = 0; j < PATCH_PER_BLOCK; ++j) \n\
        { \n\
            sfpvec4 rgba = load_float_rgba(xStart + j * wsx, y, p.w, p.cstep, p.format); \n\
        ...
        for (int j = 0; j < HALO_SIZE; ++j) \n\
        { \n\
            sfpvec4 rgba = load_float_rgba(xStart + (PATCH_PER_BLOCK + j) * wsx, y, p.w, p.cstep, p.format); \n\
    ...
    { \n\
        ...
        { \n\
            ...
            int x = lx + (HALO_SIZE + j) * wsx; \n\
            sfpvec4 rgba = load_float_rgba(minIdx, y, p.w, p.cstep, p.format); \n\
            row_shared[ly][x] = rgba; \n\
        } \n\
        for (int j = 0; j < HALO_SIZE; ++j) \n\
        { \n\
