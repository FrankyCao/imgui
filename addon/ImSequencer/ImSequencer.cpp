...
namespace ImGui
{
static const char *SequencerItemTypeNames[] = {"item 1", "item 2", "item 3"};
struct MySequence : public ImGui::SequenceInterface
{
    ...
    virtual void CustomDraw(int index, ImDrawList *draw_list, const ImRect &rc, const ImRect &legendRect, const ImRect &clippingRect, const ImRect &legendClippingRect)
    {
        ...
        draw_list->AddText(pta, 0xFFFFFFFF, GetItemLabel(index));
        draw_list->PopClipRect();
...
void ShowSequencerDemoWindow()
{
    ...
    if (mySequence.myItems.size() == 0)
    {
        ...
        mySequence.myItems.push_back(MySequence::MySequenceItem{0, 0, 200, true});
        mySequence.myItems.push_back(MySequence::MySequenceItem{1, 0, 200, true});
        mySequence.myItems.push_back(MySequence::MySequenceItem{2, 0, 200, true});
    }
    ...
    ImGui::SameLine();
    if (ImGui::Button(play ? ICON_FA5_PAUSE "###sequence_play" : ICON_FA5_PLAY "###sequence_play"))
    {
        play = !play;
    }
    ImGui::PopItemWidth();
